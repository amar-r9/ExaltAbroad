	...
	<div class="offset-sidebar">
		...
		<div class="offset-widget mb-40">
			<div class="info-widget">
				...
				<p class="mb-30">But I must explain to you how all this mistaken
					idea of denouncing pleasure and praising pain was born and will
		...
		<div class="offset-widget mb-30 pr-10">
			<div class="info-widget info-widget2">
				...
				<p>
					<i class="fal fa-envelope-open"></i> info@lifesetbro.com
				</p>
			</div>
		</div>
	</div>
