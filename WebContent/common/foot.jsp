		...
		<div class="row mb-15">
			<div class="col-xl-3 col-lg-4 col-md-6  wow fadeInUp2 animated"
				...
				<div class="footer__widget mb-30">
					...
					<p>Your gateway to studying abroad. From selecting the right university to securing visa, we have got your back. Reach out to us now.</p>
			...
			<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp2 animated"
				...
				<div class="footer__widget mb-30 pl-40 pl-md-0 pl-xs-0">
					...
					<ul class="fot-list">
						<li><a href="#">info@lifesetbro.com</a></li>
						<li><a href="#">+91 72076 46078</a></li>
			...
			<div class="row align-items-center">
				<div class="col-lg-12">
					<div class="copyright text-center">
						<h5>
							Copyright@ 2023 <a href="#">Cultode</a>. All Rights Reserved
						</h5>
					</div>
				</div>
			</div>
