...
<head>
    ...
    <title>LifeSetBro | Turning your study abroad dreams into reality.</title>
                   ...
                   <div class="row align-items-center">
                       ...
                       <div class="col-xl-6 col-lg-6">
                            <div class="slider__content pt-15">
                                <h1 class="main-title mb-40 wow fadeInUp2 animated" data-wow-delay='.1s'>Study and work Abroad made easy with <span class="vec-shape">LifeSetBro!</span></h1>
                        ...
                        <div class="row col-12 text-center justify-content-center theme_btn">
                            ...
                            <div class="col-md-12 mt-20 text-center mb-0 wow fadeInUp2 animated" data-wow-delay='.6s'>
                                <a href="https://play.google.com/store/apps/details?id=com.app.lifesetbro&pcampaignid=web_share" 
                                	class="btn btn-light"><i class="fa fa-android"></i></a>
                                <a href="https://apps.apple.com/in/app/lifesetbro/id6468569769" 
                                	class="btn btn-light"><i class="fa fa-apple"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-5 col-lg-5">
                                <div class="chose-wrapper pl-25 pl-lg-0 pl-md-0 pl-xs-0">
                                    <div class="section-title mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                        ...
                                        <h2 class="mb-25">Why Choose LifeSetBro?</h2>
                                        <p>LifeSetBro is run by professionals who have studied, worked and run companies across multiple countries. Our aim is to help each student achieve their dreams and realise their full potential.</p>
                                    </div>
								...
								<c:forEach items="${blogs }" var="blog">                        
			                        <div class="col-lg-4 col-md-6">
			                            <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
			                                ...
			                                <a href="blog-details.html"><img src="<%=request.getContextPath() %>/web-assets/img/blog/01.jpg" alt="blog-img"></a>
			                                </div>
			                                <div class="z-blogs__content">
			                                    <h5 class="mb-25">${blog.title }</h5>
			                                    <h4 class="sub-title mb-15" style="max-height: 80px; overflow: hidden; text-overflow: ellipsis;"><a href="blog-details.html">${blog.summary }</a></h4>
                    ...
                    <div class="col-xl-8">
                        <div class="subscribe-wrapper text-center mb-30">
                           ...
                           <div class="subscribe-form-box pos-rel" id="successMsg">
                                <form action="#" id="callBackForm" method="post" class="row gx-3 comments-form contact-form">
		                            ...
		                            <input class="theme_btn message_btn mt-20" type="submit" id="send" value="SUBMIT" />
		                        </form>
                           </div>
                        </div>
                    </div>
