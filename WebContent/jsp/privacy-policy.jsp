		...
		<div class="container">
			<div class="row section-separator">
				<div class="text-justify">
					...
					<p>This Privacy Policy describes Our policies and procedures on
					...
					<ul>
						...
						<li>
							<p>
								...
								in this Agreement) refers to Ozai Living Private Limited,
						...
						<li>
							<p>
								<strong>Website</strong> refers to Lifesetbro, accessible from <a
									href="https://www.lifesetbro.com"
									rel="external nofollow noopener" target="_blank">https://www.lifesetbro.com</a>
							</p>
						</li>
						<li>
							<p>
					...
					<p>When You access the Service by or through a mobile device,
					...
					<p>While using Our Application, in order to provide features of
						Our Application, We may collect, with Your prior permission:</p>
					<ul>
						<li>Pictures and other information from your Device's camera
							and photo library</li>
					</ul>
					<p>We use this information to provide features of Our Service,
					...
					<p>You can enable or disable access to this information at any
					...
					<ul>
						<li><strong>Cookies or Browser Cookies.</strong> A cookie is
							...
							Cookies.</li>
						<li><strong>Web Beacons.</strong> Certain sections of our
					...
					<ul>
						...
						<li>
							...
							<p>Purpose: These Cookies identify if users have accepted the
								use of cookies on the Website.</p>
						</li>
						<li>
							<p>
							...
							<p>Type: Persistent Cookies</p>
							<p>Administered by: Us</p>
							<p>Purpose: These Cookies allow us to remember choices You
					...
					<p>For more information about the cookies we use and your
					...
					<ul>
						...
						<li><strong>With business partners:</strong> We may share
						...
						<li><strong>With other users:</strong> when You share
							...
							may be publicly distributed outside.</li>
						<li><strong>With Your consent</strong>: We may disclose Your
							personal information for any other purpose with Your consent.</li>
					</ul>
					<h5>Retention of Your Personal Data</h5>
					<p>The Company will retain Your Personal Data only for as long
					...
					<p>Your information, including Personal Data, is processed at
					...
					<p>You have the right to delete or request that We assist in
						deleting the Personal Data that We have collected about You.</p>
					...
					<p>If the Company is involved in a merger, acquisition or asset
					...
					<ul>
						...
						<li>Prevent or investigate possible wrong doing in connection
							with the Service</li>
						<li>Protect the personal safety of Users of the Service or
							the public</li>
						<li>Protect against legal liability</li>
					</ul>
					<h5>Security of Your Personal Data</h5>
					<p>The security of Your Personal Data is important to Us, but
						remember that no method of transmission over the Internet, or
						method of electronic storage is 100% secure. While We strive to
						use commercially acceptable means to protect Your Personal Data,
						We cannot guarantee its absolute security.</p>
					<h3>Children's Privacy</h3>
					<p>Our Service does not address anyone under the age of 13. We
					...
					<p>We may update Our Privacy Policy from time to time. We will
						...
						this page.</p>
					<p>We will let You know via email and/or a prominent notice on
					...
					<ul>
						<li>
							<p>By email: ozailiving@gmail.com</p>
						</li>
						<li>
							<p>
								By visiting this page on our website: <a
									href="https://www.lifesetbro.com/support"
									rel="external nofollow noopener" target="_blank">https://www.lifesetbro.com/support</a>
							</p>
						</li>
					</ul>
