            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-xl-2 col-lg-2 col-5">
                        <div class="logo"><a href="index.html"><img src="<%=request.getContextPath() %>/web-assets/img/logo/header_logo_one.svg" alt=""></a></div>
                    </div>
                                    ...
                                    <ul class="navbar-nav">
                                        <li class="nav-item dropdown mega-menu">
                                            ...
                                            <ul class="dropdown-menu submenu mega-menu__sub-menu-box" aria-labelledby="navbarDropdown">
                                                <li><a href="index.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon7.svg" alt=""></span> Business</a></li>
                                                <li><a href="index-2.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon8.svg" alt=""></span> Technology</a></li>
                                                <li><a href="index.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon9.svg" alt=""></span> Development</a></li>
                                                <li><a href="index-2.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon10.svg" alt=""></span> Photography</a></li>
                                                <li><a href="index.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon11.svg" alt=""></span> Digital Marketing</a></li>
                                                <li><a href="index-2.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon12.svg" alt=""></span> Programming</a></li>
                                                <li><a href="index.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon14.svg" alt=""></span> Videograpgy</a></li>
                                                <li><a href="index-2.html"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/icon13.svg" alt=""></span> Illustration</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="right-nav d-flex align-items-center justify-content-end">
                            <div class="right-btn mr-25 mr-xs-15">
                                <ul class="d-flex align-items-center">
                                    ...
                                    <li><a class="sign-in ml-20" href="login.html"><img src="<%=request.getContextPath() %>/web-assets/img/icon/user.svg" alt=""></a></li>
                                </ul>
                            </div>
    ...
    <aside class="slide-bar">
        ...
        <div class="offset-sidebar">
            <div class="offset-widget offset-logo mb-30">
                <a href="index.html">
                    <img src="<%=request.getContextPath() %>/web-assets/img/logo/header_logo_one.svg" alt="logo">
                </a>
            </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-5">
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                    <img class="mb-30" src="<%=request.getContextPath() %>/web-assets/img/category-icon/atom.svg" alt="">
                            ...
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                    <img class="mb-30" src="<%=request.getContextPath() %>/web-assets/img/category-icon/web-development.svg" alt="">
                            ...
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.4s'>
                                    <img class="mb-30" src="<%=request.getContextPath() %>/web-assets/img/category-icon/career-path.svg" alt="">
                            ...
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.5s'>
                                    <img class="mb-30" src="<%=request.getContextPath() %>/web-assets/img/category-icon/graphic-tool.svg" alt="">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-7">
                                <div class="chose-img-wrapper mb-50 pos-rel">
                                    ...
                                    <div class="feature tag_01"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/shield-check.svg" alt=""></span> Safe & Secured</div>
                                    <div class="feature tag_02"><span><img src="<%=request.getContextPath() %>/web-assets/img/icon/catalog.svg" alt=""></span> 120+ Catalog</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                <div class="z-blogs__thumb mb-30">
                                <a href="blog-details.html"><img src="<%=request.getContextPath() %>/web-assets/img/blog/02.jpg" alt="blog-img"></a>
                                </div>
                                <div class="z-blogs__content">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                                <div class="z-blogs__thumb mb-30">
                                <a href="blog-details.html"><img src="<%=request.getContextPath() %>/web-assets/img/blog/03.jpg" alt="blog-img"></a>
                                </div>
                                <div class="z-blogs__content">
                    ...
                    <div class="footer__widget mb-30">
                        <div class="footer-log mb-20">
                            <a href="index.html" class="logo">
                                <img src="<%=request.getContextPath() %>/web-assets/img/logo/header_logo_one.svg" alt="">
                            </a>
                        </div>
